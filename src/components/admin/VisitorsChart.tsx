...
interface VisitorsChartProps {
  data: { date: string; besök: number; unika: number }[];
}
  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <LineChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
        ...
        <Line type="monotone" dataKey="besök" name="Sidvisningar" stroke="#d9b667" strokeWidth={2} dot={false} />
        <Line type="monotone" dataKey="unika" name="Unika besökare" stroke="#a8556b" strokeWidth={2} dot={false} />
      </LineChart>
    </ResponsiveContainer>
  );
}
